...
class WorkSpase:
    ...
    async def work_data(self, user: "Users", api_meta: dict, result:list[dict], type_method, now: datetime, api_error:list=None,):
        all_meta = {
            'pipeline_data': None,
            "api_meta": api_meta,
            'parser_meta': None,
        ...
        try:
            ...
            self.ctx.logger.debug(f"Зашли в Exception в work_data".upper())
